...
class MyApplication:
    ...
    def create_tabs(self):
        ...
        tab_control.add(tab2, text='Settings Tab')
        self.create_settings_tab_content(tab2)

        # Tab 3 - About
        tab3 = ttk.Frame(tab_control)
        tab_control.add(tab3, text='About Tab')
    ...
    def create_main_tab_content(self, tab):
        ...
        email_label.grid(row=0, column=1, pady=10)
        self.email_entry = ttk.Entry(tab, width=30, font=('Arial', 12))
        ...
        frame_01_radio.grid(row=2, column=1, pady=5)
        self.frame_01_image_label = ttk.Label(tab)
        self.frame_01_image_label.grid(row=3, column=1, pady=5)
        ...
        frame_02_radio.grid(row=4, column=1, pady=5)
        self.frame_02_image_label = ttk.Label(tab)
        self.frame_02_image_label.grid(row=5, column=1, pady=5)
        ...
        capture_button.grid(row=6, column=1, pady=20)

        # Additional instructions
        instruction_label_green = tk.Label(tab, text="Press SPACE bar to capture", bg='green', fg='white', font=('Arial', 12))
        instruction_label_green.grid(row=7, column=1, pady=5, padx=10, sticky=tk.W)

        instruction_label_red = tk.Label(tab, text="Press ESC to cancel", bg='red', fg='white', font=('Arial', 12))
        instruction_label_red.grid(row=8, column=1, pady=5, padx=10, sticky=tk.W)
    ...
    def create_settings_tab_content(self, tab):
        ...
        choose_frame_01_button = ttk.Button(tab, text="Choose Frame 01", style='TButton', command=self.choose_frame_01_image)
        choose_frame_01_button.grid(row=len(settings)*2, column=1, pady=5)

        choose_frame_02_button = ttk.Button(tab, text="Choose Frame 02", style='TButton', command=self.choose_frame_02_image)
        choose_frame_02_button.grid(row=len(settings)*2+1, column=1, pady=5)

        choose_video_button = ttk.Button(tab, text="Choose Intro Video", style='TButton', command=self.choose_intro_video)
